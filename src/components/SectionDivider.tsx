...
const SectionDivider = () => {
  return (
    <div className="section-divider relative h-24 md:h-28 overflow-hidden">
      <div className="divider-wave-container">
        ...
        <div className="absolute bottom-0 w-full h-8 bg-gradient-to-r from-[#F9D5A7]/30 via-[#FFF8E3]/30 to-[#F9D5A7]/30"></div>
      </div>

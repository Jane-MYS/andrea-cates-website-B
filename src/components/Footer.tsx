          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-beach-text/80">
                <Mail className="w-5 h-5 mr-2 text-beach-peach" />
                <a href="mailto:andreacates@gmail.com" className="hover:text-beach-peach transition-colors">andreacates@gmail.com</a>
              </li>
              <li className="flex items-center text-beach-text/80">
                ...
                <a href="tel:+13109448493" className="hover:text-beach-peach transition-colors">310-944-8493</a>
              </li>
              <li className="flex items-center text-beach-text/80">
                <svg className="w-5 h-5 mr-2 text-beach-peach" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">

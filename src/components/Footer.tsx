          ...
          <div className="text-center mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="flex items-center justify-center">
                <Mail className="w-5 h-5 mr-2 text-beach-blue" />
                <a href="mailto:andrea@andreacates.com" className="text-beach-text/80 hover:text-beach-blue transition-colors">
              ...
              {/* Phone */}
              <div className="flex items-center justify-center">
                <svg className="w-5 h-5 mr-2 text-beach-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                </svg>
                <a href="tel:+13109448493" className="text-beach-text/80 hover:text-beach-blue transition-colors">
                  310-944-8493
                </a>
              </div>
              ...
              <div className="flex items-center justify-center">
                ...
                <span className="text-beach-text/80">Manhattan Beach & Redondo Beach, California</span>
              </div>
            </div>

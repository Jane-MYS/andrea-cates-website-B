        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12 items-start">
            ...
            <div className="p-6 bg-white/80 rounded-lg shadow-md transform transition-transform hover:scale-105 flex flex-col h-full">
              ...
              <h3 className="font-handwriting text-2xl md:text-3xl mb-3 text-theme-vivid-red min-h-[2.5em] flex items-center justify-center text-center">
                <span className="md:hidden">Sleep Optimally</span>
                <span className="hidden md:block">Sleep<br />Optimally</span>
              </h3>

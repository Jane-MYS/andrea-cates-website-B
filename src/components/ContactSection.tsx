        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-br from-beach-blue/5 to-beach-blue/10 rounded-xl p-6 text-center hover:shadow-lg transition-all duration-300">
                <div className="bg-beach-blue/20 p-4 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                  <MessageCircle className="w-8 h-8 text-beach-blue" />
                </div>
              ...
              <div className="bg-gradient-to-br from-beach-blue/5 to-beach-blue/10 rounded-xl p-6 text-center hover:shadow-lg transition-all duration-300">
                <div className="bg-beach-blue/20 p-4 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                  <Mail className="w-8 h-8 text-beach-blue" />
                </div>
                <h4 className="font-semibold text-lg mb-2">Email Inquiry</h4>
                <p className="text-sm text-beach-text/70 mb-4">Send a message with any questions about myofunctional therapy services.</p>
                <a href="mailto:andrea@andreacates.com" className="text-beach-blue hover:text-beach-blue/80 font-medium text-sm transition-colors">
                  andrea@andreacates.com
                </a>
              </div>

              {/* Follow Me Card */}
              <div className="bg-gradient-to-br from-beach-blue/5 to-beach-blue/10 rounded-xl p-6 text-center hover:shadow-lg transition-all duration-300 md:col-span-2 lg:col-span-1">
                <div className="bg-beach-blue/20 p-4 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                  <Instagram className="w-8 h-8 text-beach-blue" />
                </div>
                <h4 className="font-semibold text-lg mb-2">Follow Me</h4>
                <p className="text-sm text-beach-text/70 mb-4">Stay connected for tips and updates.</p>
                <div className="flex justify-center space-x-3">
                  <a href="https://www.instagram.com/andrea_myofunctionaltherapist" className="bg-beach-blue/20 p-2 rounded-full hover:bg-beach-blue/30 transition-colors" aria-label="Instagram" target="_blank" rel="noopener noreferrer">
                    <Instagram className="w-5 h-5" />
                  </a>
                  <a href="https://www.tiktok.com/@myofunctionaltherapist" className="bg-beach-blue/20 p-2 rounded-full hover:bg-beach-blue/30 transition-colors" aria-label="TikTok" target="_blank" rel="noopener noreferrer">

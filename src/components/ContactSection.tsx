      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-block mb-5 bg-beach-peach/20 px-4 py-2 rounded-full">
            <span className="text-beach-peach font-medium">Get In Touch</span>
          </div>
          <h2 className="font-playfair text-3xl md:text-4xl font-semibold mb-6">
            Begin Your Wellness Journey Today
          </h2>
          <p className="text-beach-text/90">
            I'm here to support you in creating a more balanced, fulfilling life. Reach out to schedule a consultation or ask any questions.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-5 gap-8">
          <div className="md:col-span-2 bg-white rounded-2xl shadow-lg p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                <div className="bg-beach-peach/20 p-3 rounded-full mr-4">
                  <Calendar className="w-6 h-6 text-beach-peach" />
                </div>
                <div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:hello@andreacates.com" className="text-beach-peach text-sm font-medium mt-1 inline-block">
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-beach-blue/20 p-3 rounded-full hover:bg-beach-blue/30 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                    <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd"></path>
                  </svg>
                </a>
                <a href="#" className="bg-beach-peach/20 p-3 rounded-full hover:bg-beach-peach/30 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input 
                    type="text" 
                    id="name" 
                    className="w-full px-4 py-3 rounded-lg border border-beach-sand focus:outline-none focus:ring-2 focus:ring-beach-peach/50"
